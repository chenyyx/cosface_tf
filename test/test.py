...
import inception_resnet_v1 as network_2
        ...
        with tf.Session() as sess:
            ...
            if args.network_type == 'resnet50':
                with slim.arg_scope(resnet_v2.resnet_arg_scope(False)):
                    # 获取 resnet50 的 prelogits 和 end_points
            ...
            # 网络结构如果是 sphere_network
            elif args.network_type == 'sphere_network':
                # 获取 sphere 网络的 prelogits，即运行网络的 inference 
            ...
            for i in range(nrof_batches):
                ...
                # print('sssssssssss', feats)
                emb_array[start_index:end_index,:] = feats
                # print('aaaaaaaaaa', emb_array)
                #pdb.set_trace()
