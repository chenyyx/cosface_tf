...
def main(args):
    ...
    # 存储一些 git 版本信息在 log 文件夹下的 text 文件中
                  ...
                  with slim.arg_scope([slim.model_variable, slim.variable], device="/cpu:0"):
                    with tf.variable_scope(tf.get_variable_scope()) as var_scope:
                        ...
                        if args.network ==  'sphere_network':
                            # 修改使用 单gpu 训练 为 multi gpu 训练添加 reuse 设置
...
def parse_arguments(argv):
    ...
    parser.add_argument('--model_def', type=str,
        help='Model definition. Points to a module containing the definition of the inference graph.', default='models.sphere_network')
